<div class="d-flex justify-content-center">
    <div class="col-md-4 formulario my-3">
        <form class="form-horizontal" method="POST" action="<?php echo SERVERURL;?>producto/Guardar">
            <fieldset>
                <legend style="color:#FFFFFF"  class="text-center"><?=$titulo?> Artículos Redes</legend>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input pattern="^(([a-zA-Záéíóúñ0-9.-]+)[ ]?([a-zA-Záéíóúñ0-9.-]+)?)+$" required class="form-control" name="Nombre" type="text" placeholder="Nombre Producto" value="<?=$p->getPro_nom()?>">
                    </div>
                    <label style="color:#FFFFFF" class="col-lg-2 control-label mt-2" for="Marca">Marca</label>
                    <div class="col-lg-10">
                        <input pattern="^(([a-zA-Záéíóúñ0-9.-]+)[ ]?([a-zA-Záéíóúñ0-9.-]+)?)+$" required class="form-control" name="Marca" type="text" placeholder="Marca" value="<?=$p->getPro_marca()?>">
                    </div>
